...
--- Code coverage of 100% doesn't guarantee a perfect model or perfect training or perfect data. A project with 100% code coverage can result in a faulty prediction and hence not error free.  ---
